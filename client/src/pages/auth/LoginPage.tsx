...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-[var(--color-primary)]/10 rounded-full blur-[120px] animate-pulse" />
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-[var(--color-secondary)]/10 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-panel rounded-2xl p-8 shadow-2xl">
          <h2 className="font-title-md text-title-md text-[var(--color-on-surface)] mb-1">Welcome back</h2>
          <p className="font-body-md text-body-md text-[var(--color-on-surface-variant)] text-sm mb-8">Sign in to your system</p>
          ...
          <div className="mt-8 text-center">
            <p className="font-body-md text-body-md text-[var(--color-on-surface-variant)] text-sm">
              New to Evolv?{' '}
              <Link to="/register" className="text-[var(--color-secondary)] hover:text-[var(--color-secondary-fixed)] transition-colors font-semibold">
                Create account
              </Link>
            </p>
          </div>
